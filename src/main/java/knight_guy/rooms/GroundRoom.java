...
public class GroundRoom implements Room, Consts {
  ...
  public void build(World world, RoomManager manager) {
    ...
    // load assets
    Image background = AssetStore.load("backgrounds/ground.png");
    ...
    Image platformImg = AssetStore.load("platforms/grass.png");
    if (platformImg == null) {
